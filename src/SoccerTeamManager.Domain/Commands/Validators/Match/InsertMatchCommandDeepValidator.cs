...
{
    public class InsertMatchCommandDeepValidator : BaseDeepValidator<InsertMatchCommand>, IDeepValidator<InsertMatchCommand>
    {
        public InsertMatchCommandDeepValidator(IPlayerRepository playerRepository,
